...
* Définition des éléments (`theme()`) de style d'un graphique, par exemple, la taille de police, la couleur de remplissage du canevas.
* Structuration hiérarchiques des éléments (notion d'héritage des propretés).
